							...
							<div class="blog-list style-2">
								...
								<div class="item">
									<div class="item-header">
										...
										<h3><a href="post.html"><?=$blog->name ?> </a></h3>
									</div>
								...
								<div class="item light">
									...
									<div class="item-footer">
										<a href="blog.html" class="left" style="color: #648126;"><strong>Electronics</strong></a>
										<span class="right">
								...
								<div class="item">
									<div class="item-header">
										<a href="post.html"><img src="<?=Yii::getAlias('@web')?>/foto/images/photos/image-49.jpg" alt="" class="item-photo" /></a>
										<h3><a href="post.html">BMW E60 Test Drive from TOP GEAR</a></h3>
									</div>
									<div class="item-content">
										<p>Sotheby’s in London is getting ready for another seasonal display of wealth, as some of world’s</p>
								...
								<div class="item">
									<div class="item-header">
										<a href="post.html"><img src="<?=Yii::getAlias('@web')?>/foto/images/photos/image-50.jpg" alt="" class="item-photo" /></a>
										<h3><a href="post.html">BMW E60 Test Drive from TOP GEAR</a></h3>
									</div>
									<div class="item-content">
										<p>Sotheby’s in London is getting ready for another seasonal display of wealth, as some of world’s</p>
